...
const budgets = [
  {
    ...
    limits: {
      ...
      // The production route set currently emits 81 lazy chunks. Keep only
      // minimal churn headroom here; byte budgets below remain authoritative
      // for transfer and parse cost.
      jsFiles: 84,
      jsRaw: 2500 * KiB,
      jsGzip: 800 * KiB,
