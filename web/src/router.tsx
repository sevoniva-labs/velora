...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'applications', element: <RequireAdminPermission anyOf={[PORTAL_MANAGE]}><AdminApplications /></RequireAdminPermission> },
      { path: 'applications/:id', element: <RequireAdminPermission anyOf={[PORTAL_MANAGE]}><AdminApplicationManagement /></RequireAdminPermission> },
