...
export default function Approvals() {
  ...
  return <PageContainer title="审批"><ProTable<ApprovalRequest> className="velora-admin-primary-table" rowKey="id" columns={columns} dataSource={approvals.data ?? []} loading={approvals.isLoading} search={{ labelWidth: 'auto' }} pagination={{ pageSize: 20 }} />
