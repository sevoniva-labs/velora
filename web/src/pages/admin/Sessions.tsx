...
export default function Sessions() {
  ...
  return <PageContainer title="登录会话">{sessions.isError ? <QueryErrorState refetch={sessions.refetch} /> : <ProTable<AdminSession> className="velora-admin-primary-table" rowKey="id" columns={columns} {...sessionTable} loading={sessions.isLoading} search={{ filterType: 'light' }} pagination={{ pageSize: 20 }} polling={30_000} />}</PageContainer>
}
