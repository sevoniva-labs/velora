...
export default function ApplicationAccess({ applicationId, view }: Props) {
  ...
  return <Space direction="vertical" size={16} style={{ width: '100%' }}>
    ...
    <ProTable<ApplicationEffectiveAccess> className="velora-admin-secondary-table" headerTitle="当前可使用人员" rowKey="userId" columns={effectiveColumns} dataSource={effective.data ?? []} loading={effective.isLoading} search={{ labelWidth: 'auto' }} pagination={{ pageSize: 20 }} />
