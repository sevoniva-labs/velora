...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'organization', element: <RequireAdminPermission anyOf={[SYSTEM_ORGANIZATION_READ, SYSTEM_DEPARTMENT_READ, SYSTEM_POSITION_READ]}><AdminOrganization /></RequireAdminPermission> },
