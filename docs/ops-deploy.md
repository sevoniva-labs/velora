...
PostgreSQL 初始化密码使用 `POSTGRES_SUPERUSER_PASSWORD_FILE`、`POSTGRES_APP_PASSWORD_FILE`、`POSTGRES_IDP_PASSWORD_FILE`；仅 Casdoor 官方 DSN 配置仍由 `CASDOOR_DATA_SOURCE_NAME` 注入。
