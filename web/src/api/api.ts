...
export interface ApplicationOnboarding { application: Application; binding?: IdentityBinding; verifications: ApplicationVerification[]; canPublish: boolean; onboardingStatus: string; nextAction: string; blockers: string[]; roles: ApplicationRole[]; provisioningTarget?: ApplicationProvisioningTarget; oneTimeClientSecret?: string }
