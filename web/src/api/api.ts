...
export interface IdentityOverview { onboardingEnabled: boolean; adminEntryEnabled: boolean; providerKey: string; adminUrlHost: string; issuer: string; connectionStatus: string; pendingApplicationCount: number }
...
export interface IdentityBindingInput { providerKey: string; protocol: string; providerApplicationRef: string; publicClientId: string; issuer?: string; redirectUris?: string[]; scopes?: string[]; expectedConfigVersion?: number }
