...
import { API_TOKEN_MANAGE, AUDIT_READ, PORTAL_MANAGE, SYSTEM_DEPARTMENT_READ, SYSTEM_POSITION_READ, SYSTEM_ROLE_READ, SYSTEM_SESSION_READ, SYSTEM_USER_GROUP_READ, SYSTEM_USER_READ } from '../auth/permissions'
...
export const adminNavItems: AdminNavItem[] = [
  ...
  {
    key: 'admin-governance', label: '权限治理', icon: <SafetyOutlined />, permissions: [SYSTEM_ROLE_READ],
    children: [{ key: 'admin-roles', path: '/admin/roles', label: '平台角色', permissions: [SYSTEM_ROLE_READ] }],
  },
  {
